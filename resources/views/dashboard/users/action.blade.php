<div class="d-inline-flex">
  ...
  <div class="dropdown-menu dropdown-menu-end">
    ...
    <a href="{{ route('users.permissions.edit', $id) }}" class="dropdown-item">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <form id="item-delete-{{ $id }}" action="{{ route('users.destroy', $id) }}" method="POST" style="display: none;">
      @csrf
      @method('delete')
    </form>
  </div>
...
<a href="{{ route('users.edit', $id) }}" class="item-edit">
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
