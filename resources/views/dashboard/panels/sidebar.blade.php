    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      {{-- <li class="nav-item has-sub open">
        <a href="#" target="_self" class="d-flex align-items-center">
          ...
          <span class="badge mr-1 ml-auto badge-light-warning badge-pill"> 2 </span>
        </a>
        <ul class="menu-content collapse show" style="" id="__BVID__1004">
          <li class="nav-item">
      ...
      <li class="nav-item active">
        <a href="#" aria-current="page" class="d-flex align-items-center router-link-exact-active router-link-active">
          <svg xmlns="http://www.w3.org/2000/svg" width="14px" height="14px" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shield">
            <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>
          </svg>
          <span class="menu-title text-truncate">Access Control</span>
        </a>
      </li> --}}
      @if (isset($menuData[0]))
